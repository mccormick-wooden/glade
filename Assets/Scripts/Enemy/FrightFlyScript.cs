...
public class FrightFlyScript : BaseEnemy
{
    //GameObject biteObject;
    ...
    protected override void Start()
    {
        ...
        weapon = base.gameObject.transform.Find("RigJawGizmo").Find("Bite")?.GetComponent<BiteAttack>();
    ...
    protected override void UpdateAnimations()
    {
        ...
        if (isAttacking)
        {
            animator.SetTrigger(BITE_ATTACK_HIGH);
